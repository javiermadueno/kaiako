    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/hello')) {
            ...
            if (preg_match('#^/hello/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'backend_homepage')), array (  '_controller' => 'kaiako\\BackendBundle\\Controller\\DefaultController::indexAction',));
            }

            // ad_homepage
            if (preg_match('#^/hello/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'ad_homepage')), array (  '_controller' => 'kaiako\\AdBundle\\Controller\\DefaultController::indexAction',));
            }
